  ...
  return (
    <nav className="flex flex-col md:flex-row items-center justify-between w-11/12 mx-auto pt-2 ">
      <div className="flex items-center justify-between w-11/12 md:w-fit">
        ...
        <button
          className="text-4xl font-bold text-lime-900 md:invisible"
      ...
      <div></div>
      <ul
        className={`flex w-2/3 gap-2 lg:gap-2 md:w-1/3 mx-auto md:-mr-1 items-center justify-around md:bg-inherit flex-col md:flex-row bg-green-400 ${
